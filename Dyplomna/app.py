...
app = Flask(__name__)
app.secret_key = 'your-secret-key-here'  # Секретний ключ для сесій

# Налаштування підключення до бази даних
app.config['SQLALCHEMY_DATABASE_URI'] = (f"mysql://{os.getenv('MYSQL_USER')}:"
                                         f"{os.getenv('MYSQL_PASSWORD')}@{os.getenv('MYSQL_HOST')}/{os.getenv('MYSQL_DATABASE')}")
